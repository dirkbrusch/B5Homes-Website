  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-44 lg:pb-28">
        ...
        <div className="absolute top-24 left-[20%] h-64 w-64 rounded-full bg-nature/5 blur-3xl" />
        <div className="absolute bottom-10 right-[15%] h-48 w-48 rounded-full bg-gold/5 blur-3xl" />

        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-nature/20 bg-nature/5 px-4 py-1.5 text-sm">
              <MapPin className="h-3.5 w-3.5 text-nature" />
              <span className="text-xs font-medium uppercase tracking-wider text-nature">
                Discover
              </span>
            </div>
            <h1 className="mt-8 font-serif text-4xl font-bold sm:text-5xl lg:text-6xl">
              Greenville,
              <br />
              <span className="text-nature">South Carolina</span>
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="relative aspect-video overflow-hidden rounded-3xl shadow-2xl">
            <Image
              ...
              alt="Aerial view of B5 Homes and surrounding Greenville forest"
              fill
